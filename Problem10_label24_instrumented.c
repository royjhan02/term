...
int main()
{
    ...
    // main i/o-loop
    while(1)
    {printf("CBMC Instrumentation @ line593");static bool pStored = false;bool flag=__VERIFIER_nondet_bool();static int oa1;static int oa10;static int oa12;static int oa19;static int oa4;static int oinputB;static int oinputC;static int oinputD;static int oinputE;static int oinputF;static int ooutput;if(pStored){__CPROVER_assert(!(oa1==a1 && oa10==a10 && oa12==a12 && oa19==a19 && oa4==a4 && oinputB==inputB && oinputC==inputC && oinputD==inputD && oinputE==inputE && oinputF==inputF && ooutput==output),"recurrent state found");} if(flag){oa1=a1;oa10=a10;oa12=a12;oa19=a19;oa4=a4;oinputB=inputB;oinputC=inputC;oinputD=inputD;oinputE=inputE;oinputF=inputF;ooutput=output;pStored=true;}
        // read input
        int input;

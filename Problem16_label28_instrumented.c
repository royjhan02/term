...
int main()
{
    ...
    // main i/o-loop
    while(1)
    {printf("DirNT State @ line1784: <");printf("a12=%d,",a12);printf("a15=%d,",a15);printf("a16=%d,",a16);printf("a18=%d,",a18);printf("inputA=%d,",inputA);printf("inputB=%d,",inputB);printf("inputC=%d,",inputC);printf("inputD=%d,",inputD);printf("inputE=%d,",inputE);printf("inputF=%d,",inputF);printf("output=%d,",output);printf(">\n");
        // read input
        int input;

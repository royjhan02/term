...
int (cstrcmp)(const char *s1, const char *s2)
 {
     ...
     __VERIFIER_reached_control(367, " ");
 while (*s1 != '\0' && *s1 == *s2) {printf("CBMC Instrumentation @ line367");static myBool pStored = myFalse;myBool flag=__VERIFIER_nondet_myBool();static const char * os1;static const char * os2;static unsigned char ouc1;static unsigned char ouc2;if(pStored){__CPROVER_assert(!(os1==s1 && os2==s2 && ouc1==uc1 && ouc2==uc2),"recurrent state found");} if(flag){os1=s1;os2=s2;ouc1=uc1;ouc2=uc2;pStored=myTrue;}  __VERIFIER_loop_head(367, " ");
...
int main() {
    ...
    { __VERIFIER_reached_control(378, " ");
if (length1 < 1) { __VERIFIER_control_true(378, " ");

        length1 = 1;
    }}
    { __VERIFIER_reached_control(381, " ");
if (length2 < 1) { __VERIFIER_control_true(381, " ");

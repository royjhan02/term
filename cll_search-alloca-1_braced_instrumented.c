...
node_t* init_cll (int n)
{
  ...
  curr->val = 0;
  head = curr;
 myBool pStored0 = myFalse; __VERIFIER_reached_control(552, " ");
 for (int i = 1; i < n; i++) { __VERIFIER_loop_head(552, " ");
...
{
  node_t* curr = head;
 myBool pStored0 = myFalse; __VERIFIER_reached_control(564, " ");
 while (curr->val != i) { __VERIFIER_loop_head(564, " ");
...
if (n < 1) { __VERIFIER_control_true(571, " ");

    return 0;
  }}
  node_t* head = init_cll(n);
  int m = __VERIFIER_nondet_int();
  { __VERIFIER_reached_control(576, " ");
if (m < 0) { __VERIFIER_control_true(576, " ");

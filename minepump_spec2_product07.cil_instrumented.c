...
{ int splverifierCounter ;
  ...
  {
  while (1) {printf("DirNT State @ line302: <");printf("methaneLevelCritical=%d,",methaneLevelCritical);printf("pumpRunning=%d,",pumpRunning);printf("retValue_acc=%d,",retValue_acc);printf("splverifierCounter=%d,",splverifierCounter);printf("systemActive=%d,",systemActive);printf("tmp=%d,",tmp);printf("waterLevel=%d,",waterLevel);printf(">\n");
...
{ struct __UTAC__EXCEPTION *excep ;
  ...
  cf = *mem_15;
  {
  while (1) {printf("DirNT State @ line483: <");printf("__cil_tmp10=%d,",__cil_tmp10);printf("__cil_tmp11=%d,",__cil_tmp11);printf("__cil_tmp12=%d,",__cil_tmp12);printf("__cil_tmp13=%d,",__cil_tmp13);printf("__cil_tmp14=%d,",__cil_tmp14);printf("__cil_tmp5=%d,",__cil_tmp5);printf("__cil_tmp6=%d,",__cil_tmp6);printf("__cil_tmp7=%d,",__cil_tmp7);printf("__cil_tmp8=%d,",__cil_tmp8);printf("__cil_tmp9=%d,",__cil_tmp9);printf("choice=%d,",choice);printf("methaneLevelCritical=%d,",methaneLevelCritical);printf("pumpRunning=%d,",pumpRunning);printf("retValue_acc=%d,",retValue_acc);printf("splverifierCounter=%d,",splverifierCounter);printf("systemActive=%d,",systemActive);printf("tmp=%d,",tmp);printf("tmp___0=%d,",tmp___0);printf("tmp___1=%d,",tmp___1);printf("tmp___2=%d,",tmp___2);printf("waterLevel=%d,",waterLevel);printf(">\n");
...
{ struct __UTAC__EXCEPTION *excep ;
  ...
  cf = *mem_16;
  {
  while (1) {printf("DirNT State @ line540: <");printf("__cil_tmp10=%d,",__cil_tmp10);printf("__cil_tmp11=%d,",__cil_tmp11);printf("__cil_tmp12=%d,",__cil_tmp12);printf("__cil_tmp13=%d,",__cil_tmp13);printf("__cil_tmp14=%d,",__cil_tmp14);printf("__cil_tmp5=%d,",__cil_tmp5);printf("__cil_tmp6=%d,",__cil_tmp6);printf("__cil_tmp7=%d,",__cil_tmp7);printf("__cil_tmp8=%d,",__cil_tmp8);printf("__cil_tmp9=%d,",__cil_tmp9);printf("choice=%d,",choice);printf("methaneLevelCritical=%d,",methaneLevelCritical);printf("pumpRunning=%d,",pumpRunning);printf("retValue_acc=%d,",retValue_acc);printf("splverifierCounter=%d,",splverifierCounter);printf("systemActive=%d,",systemActive);printf("tmp=%d,",tmp);printf("tmp___0=%d,",tmp___0);printf("tmp___1=%d,",tmp___1);printf("tmp___2=%d,",tmp___2);printf("waterLevel=%d,",waterLevel);printf(">\n");
...
{ void *retValue_acc ;
  ...
  if (mode == 1) {
    temp = head;
    {
    while (1) {printf("DirNT State @ line625: <");printf("__cil_tmp10=%d,",__cil_tmp10);printf("__cil_tmp11=%d,",__cil_tmp11);printf("__cil_tmp12=%d,",__cil_tmp12);printf("__cil_tmp13=%d,",__cil_tmp13);printf("__cil_tmp14=%d,",__cil_tmp14);printf("__cil_tmp15=%d,",__cil_tmp15);printf("__cil_tmp5=%d,",__cil_tmp5);printf("__cil_tmp6=%d,",__cil_tmp6);printf("__cil_tmp7=%d,",__cil_tmp7);printf("__cil_tmp8=%d,",__cil_tmp8);printf("__cil_tmp9=%d,",__cil_tmp9);printf("choice=%d,",choice);printf("methaneLevelCritical=%d,",methaneLevelCritical);printf("pumpRunning=%d,",pumpRunning);printf("retValue_acc=%d,",retValue_acc);printf("splverifierCounter=%d,",splverifierCounter);printf("systemActive=%d,",systemActive);printf("tmp=%d,",tmp);printf("tmp___0=%d,",tmp___0);printf("tmp___1=%d,",tmp___1);printf("tmp___2=%d,",tmp___2);printf("waterLevel=%d,",waterLevel);printf(">\n");
...
{ int i ;
  ...
  {
  while (1) {printf("DirNT State @ line783: <");printf("__cil_tmp10=%d,",__cil_tmp10);printf("__cil_tmp11=%d,",__cil_tmp11);printf("__cil_tmp12=%d,",__cil_tmp12);printf("__cil_tmp13=%d,",__cil_tmp13);printf("__cil_tmp14=%d,",__cil_tmp14);printf("__cil_tmp15=%d,",__cil_tmp15);printf("__cil_tmp16=%d,",__cil_tmp16);printf("__cil_tmp4=%d,",__cil_tmp4);printf("__cil_tmp5=%d,",__cil_tmp5);printf("__cil_tmp6=%d,",__cil_tmp6);printf("__cil_tmp7=%d,",__cil_tmp7);printf("__cil_tmp8=%d,",__cil_tmp8);printf("__cil_tmp9=%d,",__cil_tmp9);printf("choice=%d,",choice);printf("count=%d,",count);printf("i=%d,",i);printf("methaneLevelCritical=%d,",methaneLevelCritical);printf("pumpRunning=%d,",pumpRunning);printf("retValue_acc=%d,",retValue_acc);printf("splverifierCounter=%d,",splverifierCounter);printf("systemActive=%d,",systemActive);printf("tmp=%d,",tmp);printf("tmp___0=%d,",tmp___0);printf("tmp___1=%d,",tmp___1);printf("tmp___2=%d,",tmp___2);printf("waterLevel=%d,",waterLevel);printf(">\n");

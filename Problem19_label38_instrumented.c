...
int main()
{
    ...
    // main i/o-loop
    while(1)
    {printf("DirNT State @ line9795: <");printf("a14=%d,",a14);printf("a21=%d,",a21);printf("a27=%d,",a27);printf("a8=%d,",a8);printf("a9=%d,",a9);printf("inputA=%d,",inputA);printf("inputB=%d,",inputB);printf("inputC=%d,",inputC);printf("inputD=%d,",inputD);printf("inputE=%d,",inputE);printf("inputF=%d,",inputF);printf("output=%d,",output);printf(">\n");
        // read input
        int input;

...
int main()
{
    ...
    // main i/o-loop
    while(1)
    {printf("DirNT State @ line4827: <");printf("a=%d,",a);printf("a1=%d,",a1);printf("a14=%d,",a14);printf("a25=%d,",a25);printf("a26=%d,",a26);printf("a28=%d,",a28);printf("a3=%d,",a3);printf("a4=%d,",a4);printf("a7=%d,",a7);printf("b=%d,",b);printf("c=%d,",c);printf("d=%d,",d);printf("e=%d,",e);printf("f=%d,",f);printf("output=%d,",output);printf("u=%d,",u);printf("v=%d,",v);printf("w=%d,",w);printf("x=%d,",x);printf("y=%d,",y);printf("z=%d,",z);printf(">\n");
        // read input
        int input;

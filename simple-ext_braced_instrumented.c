...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ { __VERIFIER_reached_control(12, " ");
if (0) { __VERIFIER_control_true(12, " ");
;} else { __VERIFIER_control_false(12, " ");
__assert_fail ("0", "simple-ext.c", 3, __extension__ __PRETTY_FUNCTION__);}} })); }
...
int main() {
  ...
  { __VERIFIER_reached_control(533, " ");
if (a == 0) { __VERIFIER_control_true(533, " ");
myexit(1);}}
  List t;
  List p = a;
  int i = 0;
...
if (t == 0) { __VERIFIER_control_true(540, " ");
myexit(1);}}
    p->n = t;
    p = p->n;
    i++;
